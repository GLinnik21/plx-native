...
# Ported so far: img, stream, aq, mkv, pms, posters, text — impls in rust-modules/.
...
SRCS = $(filter-out src/gpdebug.c src/img.c src/stream.c src/aq.c src/mkv.c src/pms.c src/posters.c src/text.c,$(wildcard src/*.c))
OBJS = $(SRCS:.c=.o)
