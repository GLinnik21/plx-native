...
/* The transport HUD (draw_hud + fmt_time + the icon glyphs) moved to the Rust
 * ui::player_hud module; it reads pl_scrub_ns/g_playpos_ns/pl_dur_ns/pl_paused
 * (below) and route::g_title/g_ctxline. */
