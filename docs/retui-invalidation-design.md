...
> §5.5. `app/recorder.rs` still describes product replay as live-assisted: `AppInit` is coarse
> (with Home hubs added separately), adapter/store result injection is incomplete, and the
