...
impl Page {
    ...
    fn title(self) -> &'static str {
        ...
        if crate::i18n::is_es() {
            return match self {
                ...
                Self::Source => "Código fuente de PlxNative",
    ...
    fn subtitle(self) -> &'static str {
        if crate::i18n::is_es() {
            return match self {
                Self::Privacy => "Cómo gestiona PlxNative los datos locales y los informes opcionales.",
