...
/// about a shared server ("Shared by <peer-owner-1>"), the machine name staying in the sources list.
///
...
mod tests {
    ...
    fn owned_and_shared_resources_round_trip_with_explicit_nulls() {
        let json = br#"[
          ...
          {"name":"<peer-name-2>","clientIdentifier":"bbbb2222","provides":"server",
           "owned":false,"home":false,"presence":true,"publicAddressMatches":false,
           "httpsRequired":false,"sourceTitle":"<peer-owner-1>","ownerId":987654,"accessToken":"tok-share",
           "connections":[
        ...
        assert_eq!(share.source_title.as_deref(), Some("<peer-owner-1>"));
